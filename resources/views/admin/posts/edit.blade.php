                ...
                <div class="card bg-secondary shadow mb-8">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">تعديل بيانات المقال</h3>
                            </div>
                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="author" value="{{$post->author}}" class="form-control form-control-alternative">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <img src="{{asset('uploads/posts/'.$post->image)}}" style="width: 100%">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
