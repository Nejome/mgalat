...
@section('content')
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <h3 class="mb-0">المدن</h3>
                            </div>
                            <div class="col-6 text-left">
                                <a href="#" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#CreateModal">اضافة مدينة</a>
                            </div>
                                        ...
                                        <div class="modal-body p-0">
                                            <div class="card bg-secondary shadow border-0">
                                                <div class="card-header bg-transparent">
                                                    <div class="text-muted text-center mt-2 mb-2">اضافة مدينة</div>
                                                </div>
                                                <div class="card-body px-lg-5 py-lg-5">

                                                    <form method="POST" action="{{url('/admin/cities/store')}}" role="form">
                                                        {{csrf_field()}}
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            @foreach($cities as $row)
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="{{url('admin/cities/'.$row->id.'/edit')}}">
                                            <i class="fas fa-pen text-warning"></i>
                                        </a>
                                        &nbsp;&nbsp;&nbsp;
                                        <a href="#" onclick="delete_confirm('{{$row->id}}', '{{url('admin/cities/'.$row->id.'/delete')}}')">
    ...
    <script>
        function delete_confirm(id, url) {
            var result = confirm('هل انت متأكد انك تريد حذف هذه المدينة ؟');
            if(result){
                location.href = url;
            }
        }
