                                ...
                                <div class="row">
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-6">
                                                    <div class="custom-control custom-radio mb-3">
                                                        <input name="is_special" value="1" class="custom-control-input" id="special" type="radio" @if(old('is_special') == 1) checked @endif>
                                                        <label class="custom-control-label" for="special">مميز</label>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="custom-control custom-radio mb-3">
                                                        <input name="is_special" value="0" class="custom-control-input" id="not_special" type="radio" @if(old('is_special') != 1) checked  @endif>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="special_until" class="form-control form-control-alternative" @if(old('is_special') != 1) disabled @endif>
