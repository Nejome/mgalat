...
@section('content')
    ...
    <section class="steps-area mb-5">
        <div class="container">
            ...
            <h3>بثلاث خطوات بسيطه تستطيع الحصول علي الخدمة</h3>
            <div class="row mt-5">
...
<g>
    ...
    <section class="mb-5">
        <div class="container">
            <h2 class="application-title phone-under-line text-center mb-5">ميزات التطبيق</h2>
            <p class="text-right" style="font-size: 16px;font-weight: 600;">
            <ol class="text-right">
                <li>مجالات تك هو التطبيق الأمثل لخدمات الصيانة الاحترفية بأسرع وقت وبأعلي جودة</li>
                <li>يسمح تطبيق مجالات تك بطلب الخدمات كافة علي مدار الساعة. ويمكنك ايضاً استخدامه في اي وقت تريد واينما كنت حتي في الإجازات والعطل الرسمية</li>
                <li>تطبيق مجالات تك متوفر بإصدارين (IOS و Android) وهو الأفضل علي الاطلاق من حيث الوضوح وسهولة الاستخدام والأمان وسرعة ملئ البيانات</li>
                <li>سرعة وصول طاقم العمل بفضل نظام ال GPS الذي يعتمده التطبيق</li>
                <li>السرعة في طلب الخدمة حيث انك تستطيع حجز خدمتك خلال دقائق قليلة عبر الخطوات التالية :
                    <ul>
                        <li>أختر الخدمة</li>
                        <li>حدد عنوان تنفيذها مع بعض التفاصيل المتعلقة ببياناتك</li>
                        <li>احجز الخدمة واختر موعد تنفيذها</li>
                    </ul>
                </li>
            </ol>
            </p>
    ...
    <section class="mb-5">
        <div class="container">
            <h2 class="application-title phone-under-line text-center mb-5">فيديو لعرض التطبيق</h2>
            <div class="brief-image-container mb-4">
                <iframe width="100%" height="500" src="{{$setting->application_video_link}}"></iframe>
            </div>
        </div>
    </section>
